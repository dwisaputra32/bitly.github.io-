...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> Perpustakaan Digital
        </div>
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">PERPUSTAKAAN SMK SATRYA BUDI KARANG REJO</h2>
            <p class="text-center">Alamat : Jl. ANJANGSANA NO.83 KARANG REJO </p>
        </div>
    </section>